...
```{r load data}
setwd('../data/')
MME <-read_csv("raw_fish_kill_data_10_24_2018.csv")
thermal <-read_csv("raw_thermal_metrics.csv")
NHD_WBIC <-read_csv("raw_NHD_WBIC.csv") %>%
...
```{r}
setwd("../data")
thermal <- read_tsv('raw_ACCESS_thermal_metrics.tsv') %>%
