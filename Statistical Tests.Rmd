...
anova_data = fig1bd_data  %>% filter(cause.category.4 == 'Winter Non-event'| cause.category.4 == 'winterkill')
...
control_data = fig1bd_data %>% filter(cause.category.4 == 'Winter Non-event')
...
winterkill_data = fig1bd_data %>% filter(cause.category.4 == 'winterkill')
...
control_data = fig_SI3_data %>% filter(winterkill == 0)
winterkill_data = fig_SI3_data %>% filter(winterkill == 1)
